...
namespace Constant
{
    public class CryptoConstant
    {
        ...
        public static readonly int AadSize = 16;
        public static readonly String Algorithm = "AES/GCM/NOPADDING";
        public static readonly int Iterations = 310000;
        public static readonly int KdfKeySize = 32;
    }
